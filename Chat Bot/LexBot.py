...
def book_trip(intent_request):
    ...
    return close(
        ...
        {
            'contentType': 'PlainText',
            'content': 'Thanks, I have placed your trip reservation.'
        }
    )
...
def dispatch(intent_request):
    ...
    intent_name = intent_request['sessionState']['currentIntent']['name']
    ...
    if intent_name == 'BookHotel':
        ...
        return book_trip(intent_request)
